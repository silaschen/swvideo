<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/data/home/bxu2442190303/htdocs/application/index/view/index/taglist.html";i:1512454433;s:70:"/data/home/bxu2442190303/htdocs/application/index/view/index/base.html";i:1512454433;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo url('Index/taglist'); ?>">tags</a></li>
       	<li><a href="javascript:alert('we are SW team')">about us</a></li>
      </ul>
...
<div class="container text-center video" style="padding-top: 10%;width: 80%; ">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$t): ?>
					...
					<a href="<?php echo U('Index/videolist'); ?>?tag=<?php echo $t['tag']; ?>"  style="<?php echo $style[rand(0,7)]; ?>;font-size: <?php echo rand(15,30); ?>px;display: inline-block;"><?php echo $t['tag']; ?></a>
...
<div class="container text-center" style="position: fixed;bottom: 15px;height: 40px;line-height: 20px;left: 0;right: 0">
